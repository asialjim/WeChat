...
public class GetUpstreamMsgHourRes extends BaseWeChatApiRes {
     ...
     * 数据列表
     */
    private List<UpstreamMsgHourData> list;
    ...
    public static class UpstreamMsgHourData implements Serializable {
